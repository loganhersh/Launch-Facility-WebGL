 ...
 */
    ...
    /*
     * MODIFIED by Logan Hershberger to add zoom function using wheel event.
     * The zoom function relies on the main program to keep track of the mouse
     * location in two variables: mouseX, mouseY.
     * This is to prevent the page from scrolling while zooming within the canvas
     * and vice versa.
     */
function TrackballRotator(canvas, callback, viewDistance, viewpointDirection, viewUp) {
    ...
    canvas.addEventListener("wheel", doWheel, false);   // modified
   ...
   // Mouse wheel zoom feature added by Logan Hershberger
    function doWheel(evt) {
        var rect = document.getElementById("webglcanvas").getBoundingClientRect();
